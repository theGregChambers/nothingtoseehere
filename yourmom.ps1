...
.DESCRIPTION 
	Demo Script for Chaos Box...it is 4am...do you know where your childern are?
#>
#############################################################################################################################################

# this is the message that will be coded into the image you use as the wallpaper

$hiddenMessage = "tell your mom to make the meatloaf I like"
...
echo "Your machine has been compromised. #RedTeamWins " >> $Env:temp\foo.txt
echo "I was able to trick your system into thinking that I was a harmless keyboard. " >> $Env:temp\foo.txt
